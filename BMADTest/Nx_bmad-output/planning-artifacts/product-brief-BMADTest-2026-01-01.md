...
A **modern, modular, web-based HMS** built on a robust, industry-standard stack (Angular, Python FastAPI, PostgreSQL). The system prioritizes:
1.  **Viability:** Core modules (Patient Management, Triage, CPOE) that work out-of-the-box.
2.  **Architecture:** An "Internal-as-External" design using HL7/FHIR queues, allowing modules to be swapped or extended without breaking the core.
