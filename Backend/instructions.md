...
- Use below nuget packages:
    ...
    dotnet tool run dotnet-ef dbcontext scaffold "Host=localhost;Port=5432;Database=dvdrental;Username=username;Password=password" Npgsql.EntityFrameworkCore.PostgreSQL -o DBModel -c DvdRentalContext -f --schema public
